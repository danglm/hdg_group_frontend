    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      ...
      >
        ...
        <div class="flex items-start gap-3 mb-3">
          <div class="p-2.5 rounded-xl text-white shadow-sm flex items-center justify-center" :style="{ backgroundColor: fund.color }">
            <el-icon :size="20">
              <component :is="getIcon(fund.icon)" />
            </el-icon>
          </div>
          <div class="flex-1 min-w-0 text-left">
            <h4 class="font-bold text-gray-800 dark:text-gray-100 text-[15px] line-clamp-1 leading-snug">{{ fund.name }}</h4>
