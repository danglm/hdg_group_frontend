<template>
  <div class="telegram-groups-list h-full p-6 overflow-y-auto flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div v-if="currentStep === 1" v-loading="loading" class="flex-1 min-h-0 overflow-y-auto">
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0 text-left">
              <h4 class="font-bold text-gray-800 dark:text-gray-100 text-[15px] line-clamp-2 leading-snug">
                {{ proj.project_name }}
              </h4>
...
import { Connection, ChatLineRound, ArrowLeft, ArrowRight, User, MoreFilled, View, CopyDocument } from '@element-plus/icons-vue'
